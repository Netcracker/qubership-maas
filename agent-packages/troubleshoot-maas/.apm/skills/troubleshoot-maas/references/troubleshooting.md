...
- [MaaS troubleshooting guide](#maas-troubleshooting-guide)
  - [Why MaaS responds with Forbidden (403) error code with
    correct credentials](#why-maas-responds-with-forbidden-403-error-code-with-correct-credentials)
  - [Why Cloud-Core deployment fails with validation of
    MaaS](#why-cloud-core-deployment-fails-with-validation-of-maas)
  ...
  - [Why maas-agent responds with Bad Gateway (502)
    status](#why-maas-agent-responds-with-bad-gateway-502-status)
  ...
  - [Recover Kafka topics and Rabbit vhosts](#recover-kafka-topics-and-rabbit-vhosts)
    ...
    - [Multiple topics recovery (namespace
      level)](#multiple-topics-recovery-namespace-level)
    - [Rabbit vhost recovery (namespace
      level)](#rabbit-vhost-recovery-namespace-level)
  - [Entity exists in MaaS registry but missing in Kafka or
    RabbitMQ](#entity-exists-in-maas-registry-but-missing-in-kafka-or-rabbitmq)
...
[rest_api.md][docs-rest-api] file. See security model of MaaS for more info:
[README.md#security-model][docs-security]
...
- [Get Rabbit instances][docs-get-rabbit]
- [Get Kafka instances][docs-get-kafka]

### How to register instance

- [Register Rabbit instance][docs-reg-rabbit]
- [Register Kafka instance][docs-reg-kafka]
...
[Kafka auth DTO][docs-kafka-auth]
...
an M2M token. See [Architecture][docs-architecture].
...
[Instance update][docs-instance-update]
...
[Kafka Single Topic Recovery][docs-1topic]

### Multiple topics recovery (namespace level)

[Kafka Topics Reconciliation][docs-ntopic]

### Rabbit vhost recovery (namespace level)

[Rabbit namespace recovery][docs-vhost]
...
2. If these entities are no longer needed or were created by mistake:
   - delete namespace declarations:
     - Kafka (delete all topics in namespace):
       [Delete Kafka topic][docs-del-kafka-topic]
     - RabbitMQ (delete all vhosts in namespace):
       [Delete virtual host][docs-del-vhost]
   - then remove instance registration:
     - Kafka:
       [Remove Kafka instance registration][docs-rmk]
     - RabbitMQ:
       [Remove Rabbit instance registration][docs-rmr]

[docs-rest-api]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md
[docs-security]: https://github.com/Netcracker/qubership-maas/blob/main/README.md#security-model
[docs-architecture]: https://github.com/Netcracker/qubership-maas/blob/main/README.md#architecture
[docs-get-rabbit]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#get-rabbit-instances
[docs-get-kafka]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#get-kafka-instances
[docs-reg-rabbit]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#register-rabbit-instance
[docs-reg-kafka]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#register-kafka-instance
[docs-kafka-auth]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#kafka-auth-dto
[docs-instance-update]: https://github.com/Netcracker/qubership-maas/blob/main/docs/maintenance.md#instance-update
[docs-1topic]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#Kafka-Single-Topic-Recovery
[docs-ntopic]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#Kafka-Topics-Reconciliation
[docs-vhost]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#Rabbit-namespace-recovery
[docs-del-kafka-topic]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#delete-kafka-topic
[docs-del-vhost]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#delete-virtual-host
[docs-rmk]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#remove-kafka-instance-registration
[docs-rmr]: https://github.com/Netcracker/qubership-maas/blob/main/docs/rest_api.md#remove-rabbit-instance-registration
