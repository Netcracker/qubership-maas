...
func TestAccountController_UpdatePassword(t *testing.T) {
	...
	dao.WithSharedDao(t, func(baseDao *dao.BaseDaoImpl) {
		...
		app.Put("/auth/account/manager/:name/password", SecurityMiddleware([]model.RoleName{model.ManagerRole}, nil, authService.IsAccessGranted, nil), accountController.UpdatePassword)
...
func TestAccountController_DeleteClientAccount(t *testing.T) {
	...
	dao.WithSharedDao(t, func(baseDao *dao.BaseDaoImpl) {
		...
		app.Delete("/test", SecurityMiddleware([]model.RoleName{model.ManagerRole}, nil, authService.IsAccessGranted, nil), accountController.DeleteClientAccount)
